namespace MD_graf_gui {
    public class GraphGenerator {
                            ...
                            if(istnieniePolaczen[k,i] == 1 && k != j) {
                                for(int l = 0; l < iloscWierzcholkow; l++) {
                                    if(istnieniePolaczen[l,j] == 1 && istnieniePolaczen[k,l] == 1 && l != j) {
                                        ...
                                        do { //sortujemy wierzcholki
                                            for (int l = 0; l < n - 1; l++) {
                                                if (znalezionyKwadrat[l] > znalezionyKwadrat[l + 1]) {
                                                    int tmp = znalezionyKwadrat[l];
                                                    znalezionyKwadrat[l] = znalezionyKwadrat[l + 1];
                                                    znalezionyKwadrat[l + 1] = tmp;
                                                }
                                            }
                                            n--;
                                        }
        ...
        public int liczbaKwadratow() {
            int[,]? temp = zliczanieKwadratow(istnieniePolaczen, iloscWierzcholkow, polaczenia);
            return temp == null ? 0 : temp.GetLength(0);
        }
